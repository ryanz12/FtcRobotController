...
public class BlueFarAuto extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Action phase2 = drive.actionBuilder(new Pose2d(-60, -10, Math.toRadians(15)))
        ...
        Action phase4 = drive.actionBuilder(new Pose2d(-60, -10, Math.toRadians(15)))
                .turn(Math.toRadians(-105))
                .strafeTo(new Vector2d(-30, 0))
                .strafeTo(new Vector2d(-30, 24))
                .build();

        Action phase5 = drive.actionBuilder(new Pose2d(-30, 28, Math.toRadians(-90)))
